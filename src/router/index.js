...
export const asyncRouterMap = [
...

  {
    ...
    children: [
      { path: 'table', component: _import('mychannel/mytable'), name: 'table-demo', meta: { title: 'mytable' }},
      { path: 'details', component: _import('mychannel/mydetails'), name: 'details-demo', meta: { title: 'mydetails' }}
    ]
  }
